      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-900/40 via-slate-900 to-teal-900/40 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-5xl font-bold text-white leading-tight mb-6">
            Join the admission <span className="text-emerald-400">management team</span>
          </h1>
          <p className="text-slate-400 text-lg leading-relaxed">
            Create your admin account to review applications, schedule counseling, and make admission decisions.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 overflow-y-auto">
        <div className="w-full max-w-md py-8 space-y-6">
          ...
          <div>
            ...
            <p className="text-slate-400">Join the admission management team</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Button
              type="submit"
              loading={loading}
              className="w-full bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 shadow-lg shadow-emerald-500/25 border-none"
              size="lg"
            >
          ...
          <p className="text-center text-sm text-slate-400">
            Already an admin?{' '}
            <Link href="/admin/login" className="text-emerald-400 hover:text-emerald-300 font-medium transition-colors">
              Sign in
            </Link>
          </p>
        </div>
